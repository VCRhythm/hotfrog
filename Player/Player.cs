...
namespace HotFrog.Player
{
    ...
    public class Player : Controller
    {
        ...
        //Guidance
        [SerializeField] private TouchIndicator touchIndicatorPrefab;
        [SerializeField] private Transform[] guidancePrefabs = new Transform[2];

        //Barriers
        [SerializeField] private Transform leftRockBarrier;
        [SerializeField] private Transform rightRockBarrier;
        ...
        void Update()
        {
            if (CanTouch)
            {
                ...
                {
                    ScreenCapture.CaptureScreenshot($"hfScreenShot{Time.time}.png", 4);
                }
        ...
        private void SetUpBarriers()
        {
            ...
            leftRockBarrier.position = new Vector2(-halfScreenWidth - 1, -1.8f);
            rightRockBarrier.position = new Vector2(halfScreenWidth + 1, -1.8f);
        }
    ...
    /*	private void TouchStepEnhanced(Transform step, int touchIndex)
        ...
        */
        ...
        private void SetUpTouchIndicators()
        {
            ...
            {
                touchIndicators[i] = Instantiate<TouchIndicator>(touchIndicatorPrefab);
            }
        }
