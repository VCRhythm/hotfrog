...
namespace HotFrog.Utility
{
	...
	public struct Vector4i
	{
		...
		public static Vector4i operator *(Vector4i v, int factor) =>
			new Vector4i(v.x * factor, v.y * factor, v.z * factor, v.w * factor);

		public static Vector4 operator *(Vector4i v, float factor) =>
			new Vector4(v.x * factor, v.y * factor, v.z * factor, v.w * factor);
		...
		public static Vector4i Min(Vector4i a, Vector4i b) =>
			new Vector4i(Mathf.Min(a.x, b.x), Mathf.Min(a.y, b.y), Mathf.Min(a.z, b.z), Mathf.Min(a.w, b.w));

		public static Vector4i Max(Vector4i a, Vector4i b) =>
			new Vector4i(Mathf.Max(a.x, b.x), Mathf.Max(a.y, b.y), Mathf.Max(a.z, b.z), Mathf.Max(a.w, b.w));
		...
		public Vector4i Mul(Vector4i factor) =>
			new Vector4i(x * factor.x, y * factor.y, z * factor.z, w * factor.w);
