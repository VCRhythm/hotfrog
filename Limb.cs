...
namespace HotFrog.Player
{
    public class Limb : MonoBehaviour
    {
        ...
        public int TouchIndex { get => touchIndex; set => touchIndex = value; }
        ...
        void Awake()
        {
            ...
            handRenderer = transform.Find(handName).GetComponent<SpriteRenderer>();
            originalSprite = handRenderer.sprite;

            hand = transform.Find($"{handName}Grab");
