...
namespace HotFrog.Utility
{
    ...
    public struct Vector3i
    {
        ...
        public static Vector3i operator *(Vector3i v, int factor) =>
            new Vector3i(v.x * factor, v.y * factor, v.z * factor);
        ...
        public static Vector3i Min(Vector3i a, Vector3i b) =>
            new Vector3i(Mathf.Min(a.x, b.x), Mathf.Min(a.y, b.y), Mathf.Min(a.z, b.z));

        public static Vector3i Max(Vector3i a, Vector3i b) =>
            new Vector3i(Mathf.Max(a.x, b.x), Mathf.Max(a.y, b.y), Mathf.Max(a.z, b.z));
        ...
        public Vector3i Mul(Vector3i factor) =>
            new Vector3i(x * factor.x, y * factor.y, z * factor.z);
