...
namespace HotFrog.Player
{
    public class Frog : MonoBehaviour
    {
        ...
        [SerializeField, Range(1, 20)] private int id;
        public int Id => id;
        [SerializeField] private string frogName;
        public string FrogName => frogName;
        [SerializeField, Range(0, 1)] private int isUnlocked = 0;
        public int IsUnlocked => isUnlocked;
        [SerializeField, Range(0, 1)] private int canBuy = 1;
        public int CanBuy => canBuy;
        ...
        [HideInInspector] public bool isLowered => riseState == RiseState.Lowered;
    ...
    //	private Animation backgroundAnimation;
        ...
        private Step BobStep { get => bobStep; set => bobStep = value; }

        private bool isMoving = false;
        private RiseState riseState = RiseState.Lowered;

        public Vector2 BodyPosition { get => transform.position; set => transform.position = new Vector2(value.x, value.y); }
        public Vector2 HeadPosition { get => headTransform.localPosition; set => headTransform.localPosition = new Vector2(value.x, value.y); }
        ...
        void Awake()
        {
            ...
            tongue = headTransform.Find("Tongue").GetComponent<Tongue>();
            rightPupil = headTransform.Find("RightPupil");
            leftPupil = headTransform.Find("LeftPupil");

            rightEyelidRenderer = headTransform.Find("RightEyelid").GetComponent<SpriteRenderer>();
            leftEyelidRenderer = headTransform.Find("LeftEyelid").GetComponent<SpriteRenderer>();

            rightScleraRenderer = headTransform.Find("RightSclera").GetComponent<SpriteRenderer>();
            leftScleraRenderer = headTransform.Find("LeftSclera").GetComponent<SpriteRenderer>();

            rightPupilPosition = headTransform.Find("RightPupilPosition").localPosition;
            leftPupilPosition = headTransform.Find("LeftPupilPosition").localPosition;
        }
