...
namespace HotFrog.Spawning
{
    public class SpawnManager : MonoBehaviour {
        ...
        [SerializeField] private Vector2[] spawnDirections = new Vector2[5]
        {
        ...
        void Start()
        {
            bugSpawner = transform.Find("Global").GetComponentInChildren<BugSpawner>();
        }
    ...
    /*	public void SpawnFromAll(Spawner.Type spawnerType, Vector2 direction, int spawnIndex)
        ...
        private void CollectLevelSpawners()
        {
            ...
            foreach(Spawner spawner in transform.Find("LevelSpawners").GetComponentsInChildren<Spawner>())
            {
