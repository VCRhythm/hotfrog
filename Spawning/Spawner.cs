...
namespace HotFrog.Spawning
{
    ...
    public class Spawner : MonoBehaviour
    {
        ...
        [SerializeField] private bool hasDiscreteMovement = false;
        [SerializeField] protected List<Vector3> Movements = new List<Vector3>();
        [ReadOnly]
        protected List<Vector3> adjustedMovements = new List<Vector3>();
        ...
        [SerializeField] private float moveTimeMax = 2f;
        [SerializeField] private float moveSpeedMin = 1f;
        [SerializeField] private float moveSpeedMax = 2f;
        protected float maxSpawnCount = -1;
        [SerializeField] protected float spawningSpeedMin = 2f;
        [SerializeField] protected float spawningSpeedMax = 2f;
        protected float savedSpawningSpeedMin;
        protected float savedSpawningSpeedMax;
        private bool isMoving = false;

        [ReadOnly] protected bool isSpawning = false;
