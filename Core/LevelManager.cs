...
namespace HotFrog.Core
{
    public class LevelManager : MonoBehaviour
    {
        ...
        [SerializeField] private Transform spawnerParentRoot;
        [SerializeField] private LensFlare flash;
        [SerializeField] private Transform wallParent;
        [SerializeField] private Lava lava;
        [SerializeField] private Sun sun;
        [SerializeField] private Transform overlayTransform;
        [SerializeField] private Transform overlay2Transform;
        ...
        private Wall[] walls;
        private Level currentLevel => levels[levelIndex];
        ...
        void Start()
        {
            spawnerParent = spawnerParentRoot.Find("LevelSpawners");

            walls = wallParent.GetComponentsInChildren<Wall>();
            sunAnimator = sun.GetComponent<Animator>();

            overlay1 = new Overlay(overlayTransform);
            overlay2 = new Overlay(overlay2Transform);
        ...
        {
            StopCoroutine(nameof(NextTimedEvent));
            isPlaying = false;
            hasStarted = false;
        ...
        void PlayLevel()
        {
            ...
            {
                StartCoroutine(nameof(NextTimedEvent));
            }
        }
        ...
        private void SetUpSpawners(Level level)
        {
            ...
            {
                Spawner spawner = Instantiate<Spawner>(level.spawners[i]);
